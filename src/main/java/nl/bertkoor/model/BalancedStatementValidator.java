...
public final class BalancedStatementValidator
        implements ConstraintValidator<BalancedStatementConstraint, BalancedStatement> {

    @Override
    public void initialize(final BalancedStatementConstraint customerStatementConstraint) {
    }
    ...
    public boolean isValid(final BalancedStatement statement,
        ...
        boolean isValid = expectedEndBalance.equals(statement.getEndBalance().setScale(2));
        if (!isValid) {
